    ...
    <div className="pt-16 pb-32 bg-gradient-to-r from-[#1c2850] to-[#3b4a7e] text-white relative overflow-hidden">
      ...
      <div className="md:flex items-center justify-center relative z-10">
        ...
        <div className="mt-10 md:mt-0 md:w-1/2 px-10 md:px-16">
          ...
          <p className="mt-5 text-lg md:text-2xl font-light leading-8 text-gray-200">
            Data faktlar qrupudur və fərqli formalarda ola bilər. Rəqəmlər, sözlər, müşahidələr, şəkillər, videolar buna misallardır. Data hər gün yaradılır və istifadə olunur.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-center mt-20 relative z-10">
        <div className="mt-10 md:mt-0 md:w-1/2 px-10 md:px-16">
          ...
          <p className="mt-5 text-lg md:text-2xl font-light leading-8 text-gray-200">
            Analitika datada olan əhəmiyyətli nümunələrin tapılması, interpretasiya edilməsi və çatdırılması prosesidir.
          </p>
        </div>
        <div className="md:w-1/2">
          <Image
      ...
      <div className="md:flex items-center justify-center mt-20 relative z-10">
        ...
        <div className="mt-10 md:mt-0 md:w-1/2 px-10 md:px-16">
          <h2 className="text-4xl md:text-6xl font-bold text-[#ffbf00] leading-tight">
            Data analitika üzrə karyera imkanları
          </h2>
          <p className="mt-5 text-lg md:text-2xl font-light leading-8 text-gray-200">
            Şirkətlər istehlakçıların üstünlük verdikləri və tələblərini ödəmək və bazarda yaranan tendensiyalara anında reaksiya vermək üçün data analistlərə tələb çoxdur.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-center mt-20 relative z-10">
        <div className="mt-10 md:mt-0 md:w-1/2 px-10 md:px-16">
          <h2 className="text-4xl md:text-6xl font-bold text-[#ffbf00] leading-tight">
            Data analitika təlimi kimlər üçündür?
          </h2>
          <p className="mt-5 text-lg md:text-2xl font-light leading-8 text-gray-200">
            Hər kəs üçün. Bu təlimdə iştirak etmək üçün heç bir təcrübə və ya xüsusi bilik tələb olunmur.
          </p>
        </div>
        <div className="md:w-1/2">
          <Image
            src="/images/data-4.jpg"
            alt="image"
            width={1920}
            height={1080}
            className=" shadow-xl"
